...
public class Medpay_Test {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		wd.findElement(By.xpath("//input[@id='username']")).sendKeys("EditorUser123");
		...
		wd.findElement(By.xpath("//button[@class='chakra-button css-11hsy1o']")).click();//place an order button

		Select orderPartner = new Select(wd.findElement(By.xpath("//select[@id='order_partner']")));
		orderPartner.selectByVisibleText("GoDigit");

		WebElement ActualTitle1=wd.findElement(By.xpath("//input[@id='partner_order_id']"));
				ActualTitle1.sendKeys("ABC1234567");
		...
		String ExpectedElement1="ABC123";
